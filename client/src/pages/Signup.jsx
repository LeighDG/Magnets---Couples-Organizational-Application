  ...
  return (
    <div className="auth-root">
      ...
      <main className="auth-main">
        <div className="auth-card glass-card">
          ...
          <aside className="auth-panel" aria-hidden="true">
            ...
            <p className="panel-title">Start your<br />shared journey.</p>
            <p className="panel-sub">
              Create your account, then invite your partner with a single link.
              You'll both be set up in under two minutes.
            </p>
            <div className="panel-note">
              <span className="note-icon">🔗</span>
              <span className="note-text">Free forever — no card required.</span>
            </div>
          </aside>

          {/* Right panel — form */}
          <section className="auth-form-panel" aria-label="Sign up form">
            <div className="form-eyebrow">Create account</div>
            <h1 className="form-title">Join<br /><em>Magnetic</em></h1>
      ...
      <style>{`
        ...
        .note-text { font-size: 11px; color: var(--white-55); font-weight: 300; }
